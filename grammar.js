...
module.exports = grammar({
  ...
  rules: {
    ...
    parameter_or_tuple: ($) =>
      choice($.parameter, $.tuple_pattern),
    ...
    _statement: ($) =>
      choice($.top_statement, $.if_expression, $.let_binding, $._expression),
    ...
    if_expression: ($) =>
      prec.left(1,
        seq(
          ...
          optional(seq("else", field("else_branch", $._simple_statement)))
        )
      ),
    ...
    member_expression: ($) =>
      prec.left(1,
        seq(field("object", $._primary_expression), ".", field("member", $.identifier))
      ),
    ...
    untyped_parameter_list: ($) =>
      seq(
        "(",
        optional($._untyped_parameter_sequence),
        ")"
      ),
    ...
    type: ($) =>
      choice($.generic_type, $.type_identifier, $.identifier),
